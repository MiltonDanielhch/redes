...
type LayoutRouteId = RouteId | "/(dashboard)/admin/audit" | "/(dashboard)/admin/users" | "/(dashboard)/agents" | "/(dashboard)/alerts" | "/(dashboard)/dashboard" | "/(dashboard)/devices" | "/(dashboard)/devices/[id]" | "/(dashboard)/intrusions" | "/(dashboard)/metrics" | "/(dashboard)/sedes" | "/(dashboard)/topology"
